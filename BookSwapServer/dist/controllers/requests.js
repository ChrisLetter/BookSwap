...
function getRequests(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const books = yield users_js_1.default.findOne({ _id: userId });
            res.status(200);
...
function addOneRequest(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            users_js_1.default.findOneAndUpdate({ _id: userId }, { $push: { requests: requestToInsert } }, { upsert: true });
            res.sendStatus(201);
        }
        catch (e) {
            res.sendStatus(500);
...
function changeViewedPropertyOfRequest(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const userInfos = yield users_js_1.default.findOne({ _id: idUser });
            if (userInfos) {
            ...
            users_js_1.default.findOneAndUpdate({ _id: idUser }, { requests: userInfos === null || userInfos === void 0 ? void 0 : userInfos.requests });
            res.sendStatus(201);
        }
        catch (e) {
            res.sendStatus(500);
...
function deleteRequest(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            users_js_1.default.findOneAndUpdate({ _id: idUser }, { requests: temp }).then();
            res.sendStatus(201);
        }
        catch (e) {
            res.sendStatus(500);
