...
var isbn = require('./controllers/isbn');
...
router.put('/requests/:idUser/:idOtherUser/:receiverOrSender/:trueOrFalse', requests.changeViewedPropertyOfRequest);
router.delete('/requests/:idUser/:idOtherUser/:receiverOrSender', requests.deleteRequest);
router.put('/requests/:idUser/:idOtherUser/:status/:receiverOrSender/status', requests.changeStatusRequest);
...
router.put('/messages/:idUser/:idOtherUser/:trueOrFalse/notification', messages.toggleNotificationChat);
